...
class ChatConsumer(WebsocketConsumer):
    ...
    def websocket_receive(self, message):
        ...
        if text_data['type'] == 'message':
            ...
            # elif 'dog' in text_data['message'].lower():
                # response = {
                #     'type': 'message',
                #     'name': self.customer_name,
                #     'image': 'https://image.geo.de/30042232/t/JE/v3/w1440/r0/-/deutsche-doggen-gross-jpg--17133-.jpg'
                # }
                response = '/static/images/meme/9299765.jpg'
                # response = 'https://image.geo.de/30042232/t/JE/v3/w1440/r0/-/deutsche-doggen-gross-jpg--17133-.jpg'
                self.send_image_message(response)
    ...
    #     self.customer_name = self.scope['query_string'].decode().split('=')[1]
    #     text_data = json.loads(message['text'])
    #     if " shabi " in text_data or "傻逼" in text_data:
    #         self.send(f"服务器:你才是傻逼 ")
    #         return
    #     if text_data['type'] == 'message':
    #         self.send_chat_message(text_data['message'])
    #     elif text_data['type'] == 'image':
